  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await axios.post(
        ...
        {
          headers: {
            Authorization: `Bearer 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`,
